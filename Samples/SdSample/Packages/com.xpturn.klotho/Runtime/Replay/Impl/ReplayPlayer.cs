...
namespace xpTURN.Klotho.Replay
{
    ...
    public class ReplayPlayer : IReplayPlayer
    {
        ...
        public void Load(IReplayData replayData, IKLogger logger)
        {
            ...
            if (replayData == null)
            {
                _logger?.KError($"[ReplayPlayer] Cannot load null replay data");
                return;
            }
            ...
            _logger?.KInformation($"[ReplayPlayer] Replay loaded - ticks: {replayData.Metadata.TotalTicks}, duration: {replayData.Metadata.DurationMs}ms");
        }
        ...
        public void Play()
        {
            if (_replayData == null)
            {
                _logger?.KError($"[ReplayPlayer] No replay data loaded");
                return;
            }
            ...
            _logger?.KInformation($"[ReplayPlayer] Playback started");
        }
        ...
        public void Pause()
        {
            if (_state == ReplayState.Playing)
            {
                ...
                _logger?.KInformation($"[ReplayPlayer] Playback paused");
            }
        }
        ...
        public void Resume()
        {
            ...
            {
                _state = ReplayState.Playing;
                _logger?.KInformation($"[ReplayPlayer] Playback resumed");
            }
        }
        ...
        public void Stop()
        {
            ...
            _logger?.KInformation($"[ReplayPlayer] Playback stopped");
        }
        ...
        public void SeekToTick(int tick)
        {
            ...
            _logger?.KInformation($"[ReplayPlayer] Seek: tick={tick}");
        ...
        public void Update(float deltaTime)
        {
            ...
            while (_accumulator >= tickIntervalMs && _currentTick <= TotalTicks)
            {
                ...
                if (_currentTick > TotalTicks)
                {
                    ...
                    _logger?.KInformation($"[ReplayPlayer] Playback finished");
