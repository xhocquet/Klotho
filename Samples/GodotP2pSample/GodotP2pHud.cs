// In-game HUD (Godot counterpart of the Unity P2pHud): state / score P1,P2 / match timer / result.
using global::Godot;
...
{
	public partial class GodotP2pHud : Control
	{
		...
		public void RefreshScoreAndTimer()
		{
			...
			while (filter.Next(out var entity))
			{
				...
				if (p.PlayerId == 0) score0 = p.Score;
				else if (p.PlayerId == 1) score1 = p.Score;
			}
