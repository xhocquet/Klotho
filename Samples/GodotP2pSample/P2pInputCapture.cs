// Godot input capture: WASD and arrow keys -> FP64 H/V in [-1,1]. Same namespace/signature as the
// Unity P2pInputCapture so the copied P2pSimulationCallbacks compiles unchanged.
using System;
using global::Godot;
...
{
	public class P2pInputCapture : IDisposable
	{
