...
namespace xpTURN.Klotho.Core
{
    public partial class KlothoEngine
    {
        ...
        private void HandleNetworkDesync(int playerId, int tick, long localHash, long remoteHash)
        {
            ...
            _logger?.KWarning($"[KlothoEngine][FullStateResync] Desync consecutiveCount={_consecutiveDesyncCount}/{_simConfig.DesyncThresholdForResync}, lastMatchedSyncTick={_lastMatchedSyncTick}, currentTick={CurrentTick}");
