...
namespace xpTURN.Klotho
{
    ...
    public class USessionConfig : ScriptableObject, ISessionConfig
    {
        ...
        [field: Header("LateJoin / Reconnect Policy")]
